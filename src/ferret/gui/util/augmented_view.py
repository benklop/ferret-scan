...
from ferret.util.gryphon_util import line_cross_sphere, plane_cross, pos2nd


def _platform_extrinsics():
    # Deferred: ferret.gui.engine imports image_detection → this module.
    import ferret.gui.engine as gui_engine

    return gui_engine.platform_extrinsics


def _image_detection():
    import ferret.gui.engine as gui_engine

    return gui_engine.image_detection
