...
from ferret_scan.gui.util.scene_view import SceneView
from ferret_scan.gui.util.video_view import VideoView
from ferret_scan.runtime_engine import current_video, driver
...
class ViewPage(wx.SplitterWindow):
    def __init__(self, parent, get_image):
        ...
        self.combo_video_views = wx.ComboBox(
            self.video_view, value=_('Texture'), choices=_choices, style=wx.CB_READONLY, size=(100, -1), pos=(0, -1)
        )
