...
from ferret_scan.gui.widgets import Button, CheckBox, ComboBox, ExpandablePanel, FloatTextBox, Slider
from ferret_scan.runtime_engine import ciclop_scan, driver, point_cloud_roi
...
class PointCloudColor(ExpandablePanel):
    ...
    def on_color_picker(self):
        ...
        if dialog.ShowModal() == wx.ID_OK:
            ...
            from ferret_scan.gui.util.diy_controls import _rgb_list_to_hex

            profile.settings['point_cloud_color'] = str(_rgb_list_to_hex(color))
        dialog.Destroy()
