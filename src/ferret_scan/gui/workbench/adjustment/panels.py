...
from ferret_scan.gui.widgets import CheckBox, ComboBox, ExpandablePanel, Slider
from ferret_scan.gui.workbench.adjustment.current_video import CurrentVideo
from ferret_scan.runtime_engine import image_capture, laser_segmentation
...
class ScanCapturePanel(ExpandablePanel):
    ...
    def add_controls(self):
        ...
        self.add_control('light1_texture_scanning', Slider, _('Photo lamp 1 brightness'))
        self.add_control('light2_texture_scanning', Slider, _('Photo lamp 2 brightness'))

        self.add_control(
            'brightness_laser_scanning',
            Slider,
            _(
                'Image luminosity. Low values are better for environments with high ambient '
                'light conditions. High values are recommended for poorly lit places'
        ...
        self.add_control('light1_laser_scanning', Slider, _('Photo lamp 1 brightness'))
        self.add_control('light2_laser_scanning', Slider, _('Photo lamp 2 brightness'))

        self.add_control(
            'remove_background_scanning',
            CheckBox,
            _("Capture an extra image without laser to remove the background in the laser's image"),
        )
...
class ScanSegmentationPanel(ExpandablePanel):
    ...
    def add_controls(self):
        ...
        self.add_control(
            'threshold_value_scanning', Slider, _('Remove all pixels which intensity is less that the threshold value')
        )
        self.add_control(
        ...
        self.add_control(
            'blur_value_scanning', Slider, _('Blur with Normalized box filter. Kernel size: 2 * value + 1')
        )
        self.add_control(
            'blur_enable_scanning', CheckBox, _('Blur with Normalized box filter. Kernel size: 2 * value + 1')
        )
        self.add_control(
            'window_value_scanning', Slider, _('Filter pixels out of 2 * window value around the intensity peak')
        )
        self.add_control(
            'window_enable_scanning', CheckBox, _('Filter pixels out of 2 * window value around the intensity peak')
        )
...
class CalibrationCapturePanel(ExpandablePanel):
    ...
    def add_controls(self):
        ...
        self.add_control('light1_pattern_calibration', Slider, _('Photo lamp 1 brightness'))
        self.add_control('light2_pattern_calibration', Slider, _('Photo lamp 2 brightness'))
        ...
        self.add_control('light1_laser_calibration', Slider, _('Photo lamp 1 brightness'))
        self.add_control('light2_laser_calibration', Slider, _('Photo lamp 2 brightness'))

        self.add_control(
            'remove_background_calibration',
            CheckBox,
            _("Capture an extra image without laser to remove the background in the laser's image"),
        )
...
class CalibrationSegmentationPanel(ExpandablePanel):
    ...
    def add_controls(self):
        ...
        self.add_control(
            'blur_value_calibration', Slider, _('Blur with Normalized box filter. Kernel size: 2 * value + 1')
        )
        self.add_control(
            'blur_enable_calibration', CheckBox, _('Blur with Normalized box filter. Kernel size: 2 * value + 1')
        )
        self.add_control(
            'window_value_calibration', Slider, _('Filter pixels out of 2 * window value around the intensity peak')
        )
        self.add_control(
            'window_enable_calibration', CheckBox, _('Filter pixels out of 2 * window value around the intensity peak')
        )
    ...
    def update_callbacks(self):
        ...
        self.update_callback('threshold_enable_calibration', laser_segmentation.set_threshold_enable)
