...
class Page(wx.Panel):
    def __init__(
        ...
        left='Left',
        right='Right',
        button_left_callback=None,
        button_right_callback=None,
        view_progress=False,
        layout=0,
    ):
        ...
        hbox.Add(self.left_button, 0, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT, 8)
        hbox.Add((0, 0), 1, wx.EXPAND)
        hbox.Add(self.right_button, 0, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 8)
