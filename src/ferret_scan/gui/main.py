...
from ferret_scan.gui.workbench.adjustment.main import AdjustmentWorkbench
from ferret_scan.gui.workbench.calibration.main import CalibrationWorkbench
from ferret_scan.gui.workbench.control.main import ControlWorkbench
from ferret_scan.gui.workbench.scanning.main import ScanningWorkbench
...
from ferret_scan.util import mesh_loader, profile, resources, version
...
class MainWindow(wx.Frame):
    ...
    def update_profile_to_all_controls(self):
        ...
        if wb_key not in self.workbench:
            wb_key = 'scanning'
        self.workbench[wb_key].update_controls()
    ...
    def initialize_driver(self):
        ...
        if backend == 'Revopoint DAT':
            ...
            if hasattr(driver.board, 'serial_name'):
                driver.board.serial_name = profile.settings['serial_name']
            if hasattr(driver.board, 'baud_rate'):
