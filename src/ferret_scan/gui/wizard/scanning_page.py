...
from ferret_scan.runtime_engine import ciclop_scan, driver, image_capture
...
class ScanningPage(WizardPage):
    def __init__(self, parent, button_prev_callback=None, button_next_callback=None):
        ...
        self.resolution_label.SetToolTip(wx.ToolTip(_('Set the motor step. High (0.45º), Medium (0.9º), Low (1.8º)')))
        self.resolution_combo_box = wx.ComboBox(
            self.panel,
            wx.ID_ANY,
            size=(200, -1),
            value=value,
        ...
        self.laser_combo_box = wx.ComboBox(
            self.panel,
            wx.ID_ANY,
            size=(200, -1),
        ...
        self.capture_texture_checkbox = wx.CheckBox(self.panel, size=(200, -1))
        ...
        self.capture_texture_checkbox.Bind(wx.EVT_CHECKBOX, self.on_capture_texture_checkbox_changed)
