...
class CameraSettings:
    def __init__(self, driver=None, calibration_data=None):
...
class ImageCapture:
    def __init__(self, driver=None, calibration_data=None):
        ...
        self.texture_mode = CameraSettings(driver=self.driver, calibration_data=self.calibration_data)
        self.laser_mode = CameraSettings(driver=self.driver, calibration_data=self.calibration_data)
        self.pattern_mode = CameraSettings(driver=self.driver, calibration_data=self.calibration_data)
