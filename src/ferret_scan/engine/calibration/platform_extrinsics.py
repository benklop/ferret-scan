...
from ferret_scan.engine.visualization.pattern_overlay import augmented_draw_pattern
from ferret_scan.util.scan_geometry import capture_precise_corners, rigid_transform_3D
