...
from ferret_scan.util import opengl_platform  # noqa: E402
...
try:
    ...
    # wxPhoenix deprecation warnings per session.
...
from ferret_scan.util import resources  # noqa: E402
...
# Application root (some modules read this from __main__).
...
def main():
    os.chdir(appdir)
    from ferret_scan.gui import app
